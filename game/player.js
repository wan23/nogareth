define(["require", "exports", "./thing", "./bob", "./data"], function (require, exports, thing_1, bob_1, data_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Player = void 0;
    class Player extends thing_1.Thing {
        constructor(xt, yt, bobt, l) {
            super(xt, yt, bobt, l);
            //prevent player hurt sound playing every frame
            this.hurtDelay = new Date();
            this.type_id = data_1.CONSTANTS.GameType.PLAYER;
            this.height = 20;
            this.width = 26;
            this.speed = 4;
        ...
        update() {
            ...
            if (data_1.INPUTCONTROLLER.Key_Down) {
                this.angle = 180;
                this.velocity = this.speed;
            }
            if (data_1.INPUTCONTROLLER.Key_Up) {
                this.angle = 0;
                this.velocity = this.speed;
            }
            if (data_1.INPUTCONTROLLER.Key_Left) {
                if (data_1.INPUTCONTROLLER.Key_Up)
                    this.angle = 315;
                else if (data_1.INPUTCONTROLLER.Key_Down)
                    this.angle = 225;
                else
                    this.angle = 270;
                this.velocity = this.speed;
            }
            if (data_1.INPUTCONTROLLER.Key_Right) {
                if (data_1.INPUTCONTROLLER.Key_Up)
                    this.angle = 45;
                else if (data_1.INPUTCONTROLLER.Key_Down)
                    this.angle = 135;
            ...
            //CHEATS
            if (data_1.INPUTCONTROLLER.KEY_PRESS == "1") {
                this.hasRedKey = true;
                this.hasGreenKey = true;
                this.hasBlueKey = true;
            }
            if (data_1.INPUTCONTROLLER.KEY_PRESS == "2") {
                data_1.GAME.load_level("levels\\mikeslevel.txt");
                this.x = 13 * 40;
                this.y = 26 * 40;
            }
            if (data_1.INPUTCONTROLLER.KEY_PRESS == "3") {
                data_1.GAME.load_level("levels\\juanlevel.txt");
                this.x = 12 * 40;
                this.y = 11 * 40;
            }
            if (data_1.INPUTCONTROLLER.KEY_PRESS == "4") {
                data_1.GAME.load_level("levels\\neallevel.txt");
                this.x = 95 * 40;
                this.y = 95 * 40;
            }
            if (data_1.INPUTCONTROLLER.KEY_PRESS == "5") {
                this.health = 10000000;
            }
            if (data_1.INPUTCONTROLLER.KEY_PRESS == "6") {
                this.speed = 15;
            }
            if (data_1.INPUTCONTROLLER.KEY_PRESS == "7") {
                this.speed = 4;
            }
